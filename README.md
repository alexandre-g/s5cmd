[![Go Report](https://goreportcard.com/badge/github.com/alexandre-g/s5cmd/v2)](https://goreportcard.com/report/github.com/alexandre-g/s5cmd/v2) ![Github Actions Status](https://github.com/alexandre-g/s5cmd/actions/workflows/ci.yml/badge.svg)
...
The [Releases](https://github.com/alexandre-g/s5cmd/releases) page provides pre-built
...
installed.
    ...
    go install github.com/alexandre-g/s5cmd/v2@master
...
#### Build
    $ git clone https://github.com/alexandre-g/s5cmd && cd s5cmd
...
You can upload remote objects by piping stdin to `s5cmd`:
    ...
    curl https://github.com/alexandre-g/s5cmd/ | s5cmd pipe s3://bucket/s5cmd.html
...
an [open ticket](https://github.com/alexandre-g/s5cmd/issues/29) to track the issue.
...
`numworkers` is a global option that sets the size of the global worker pool. Default value of `numworkers` is [256](https://github.com/alexandre-g/s5cmd/blob/master/command/app.go#L18).
Commands such as `cp`, `select` and `run`, which can benefit from parallelism use this worker pool to execute tasks. A task can be an upload, a download or anything in a [`run` file](https://github.com/alexandre-g/s5cmd/blob/master/command/app.go#L18).
...
MIT. See [LICENSE](https://github.com/alexandre-g/s5cmd/blob/master/LICENSE).
